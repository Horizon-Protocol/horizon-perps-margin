...
import {IPerpsV2MarketConsolidated} from
    "src/interfaces/horizon-protocol/IPerpsV2MarketConsolidated.sol";

/// @title Horizon Protocol Margin Account Implementation Interface
interface IAccount {
    /*///////////////////////////////////////////////////////////////
                                Types
    ///////////////////////////////////////////////////////////////*/
    ...
    enum Command {
        ...
        GELATO_CANCEL_CONDITIONAL_ORDER // 8
    ...
    /// @param factory: address of the Margin Account Factory
    /// @param events: address of the contract used by all accounts for emitting events
    /// @param marginAsset: address of the Horizon Protocol ProxyERC20zUSD contract used as the margin asset
    /// @param perpsV2ExchangeRate: address of the Horizon Protocol PerpsV2ExchangeRate
    /// @param futuresMarketManager: address of the Horizon Protocol FuturesMarketManager
    /// @param systemStatus: address of the Horizon Protocol SystemStatus
    /// @param gelato: address of Gelato
    /// @param automate: address of automate
    ...
    /// marketKey: Horizon Protocol PerpsV2 Market id/key
    /// marginDelta: amount of margin to deposit or withdraw; positive indicates deposit, negative withdraw
    /// sizeDelta: denoted in market currency (i.e. ETH, BTC, etc), size of Horizon Protocol PerpsV2 position
    /// targetPrice: limit or stop price target needing to be met to submit Horizon Protocol PerpsV2 order
    ...
    /// 3. keeper executes Horizon Protocol PerpsV2 order after delay period
    /// 4. if current market price defined by Horizon Protocol PerpsV2
    ...
    /// @notice thrown when a conditional order is attempted to be executed but margin account cannot pay fee
    ...
    /// @notice get delayed order data from Horizon Protocol PerpsV2
    ...
    /// @notice get up-to-date position data from Horizon Protocol PerpsV2
    /// @param _marketKey: key for Horizon Protocol PerpsV2 Market
